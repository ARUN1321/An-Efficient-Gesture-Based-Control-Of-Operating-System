...
while True:
    ...
    if len(lmList) != 0:
        ...
        if finger[1] == 1 and finger[2] == 0:  # Checks to see if the pointing finger is up and thumb finger is down
            x3 = numpy.interp(x1, (75, 640 - 75), (0, 800))  # Converts the width of the window relative to the screen width
            y3 = numpy.interp(y1, (75, 480 - 75), (0, 800))  # Converts the height of the window relative to the screen height
        ...
        if finger[0] == 1 and finger[1] == 1 and finger[2] == 1:
